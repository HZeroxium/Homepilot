...
- Phân tích thói quen truy cập: Ghi nhận thói quen người dùng để thông báo về điện thoại(dùng pushsafer)/mail(nodemailer) khi có bất thường xảy ra.
...
Note: Chỉ trả lời các câu hỏi liên quan đến hệ thống IOT, các yêu cầu về thông tin thiết bị(nhiệt độ, độ ẩm...) thì cho phép, nhưng các yêu cầu khác không liên quan thì từ chối. Bắt buộc trả lời bằng tiếng việt(Vietnamese) và định dạng chữ bình thường(không markdown).
`,
      },
      {
        role: 'user',
